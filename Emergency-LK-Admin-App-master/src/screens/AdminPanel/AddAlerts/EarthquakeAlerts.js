...
export default class EarthquakeAlerts extends Component {
    ...
    API_Submit_Alert = () => {
        ...
        fetch(API.API_SAVE_EARTHQUAKE_ALERT,{
            method:'POST',
            headers:{
    ...
    render() {
        return (
            ...
            <HeaderPrimary 
            title='Add Earthquake Alert'
            onPress={ () => this.backButtonOnPress()}
            />

            <ScrollView>
            <Image source={Assets.HOME_EARTHQUAKE} style={styles.medicalHelpImage}/>
