...
export default class TsunamiAlerts extends Component {
    ...
    clickEventListener = (item) => {
        this.props.navigation.navigate("MoreDetails",{screen:MoreDetails,Alert:item,Title:'Tsunami Warning For '})
    }
    ...
    API_Get_MissingPersons = () => {
        ...
        fetch(API.API_VIEW_TSUNAMI_ALERTS,{
            method:'GET',
            headers:{
            ...
            <FlatList 
                ...
                return (
                    ...
                    <View style={styles.cardContent}>
                        <Text style={[styles.description]}>Tsunami Warning for {item.Alert_Country}</Text>
