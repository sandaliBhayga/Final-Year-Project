...
export default class EarthquakeAlerts extends Component {
    ...
    clickEventListener = (item) => {
        this.props.navigation.navigate("MoreDetails",{screen:MoreDetails,Alert:item,Title:'Earthquake Warning For '})
    }
            ...
            <FlatList 
                ...
                return (
                    ...
                    <View style={styles.cardContent}>
                        <Text style={[styles.description]}>Earthquake Warning for {item.Alert_Country}</Text>
